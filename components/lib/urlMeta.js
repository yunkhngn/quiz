const urlMeta = {
    ...
    learning: {
        route: '/learning',
        title: 'Học tập | Quiz',
        url: 'https://quiz.khoanguyen.codes/learning',
        description: 'Chế độ học tập của Quizlet clone.',
    },
    test: {
        route: '/test',
        title: 'Kiểm tra | Quiz',
        url: 'https://quiz.khoanguyen.codes/test',
        description: 'Chế độ kiểm tra của Quizlet clone.',
    }
}
